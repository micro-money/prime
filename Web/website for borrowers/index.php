...
<div class="wrapper">
    ...
    <div class="visible-lg-block visible-md-block">
        ...
        <ul class="main__icons row">
            ...
            <li class="col-md-2 main__icons__item">
                <img height="70" alt="<?= l('Always there for you â any time, any place') ?>" src="images/clock.png">
                <span class="main__icons__title"><?= l('Always there for you â any time, any place') ?></span>
            </li>
            <li class="col-md-2 main__icons__item">
