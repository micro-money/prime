                ...
                <div class="tab-pane active">
                    <div class="row">
                        <div class="col-md-7 col-md-offset-5">
                            ...
                            <label class="control-label"><?= l('Please fill up the following fields. We need very detailed information to proceed your loan. We wonât contact any of your contacts unless we have to. Fields indicated with * are mandatory.') ?></label>
                        </div>
                    </div>
