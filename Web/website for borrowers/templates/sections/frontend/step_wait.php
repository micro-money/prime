    ...
    <div class="step">
        ...
        <!--<div class="tabs-container wizard-container">-->
          ...
          <!--We will DO OUR BEST to send you money AS SOON AS POSSIBLE!--> 							
							<p>
							<?= l('We will send you! ') ?> <?= $GLOBALS['ss_howmoney'] ?> <?= $countryid[$user['fil']]['cur'] ?> <?= l('withing 24hours') ?> <?= $GLOBALS['ss_wheremoney'] ?>!
							</p>
		...
		<div class="clearf"></div>
							...
							<ul>
								<li>
									...
									<p><a href="viber://add?number=%2B959422042220">+95 9 422 042 220</a>,</p>  
								...
								<li>
									...
									<p><a href="tel:+959422042220">+95 9 422 042 220</a>,</p>  
